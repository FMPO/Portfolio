...
namespace Project_Fisticuffs
{
    ...
    class Kairos : Player
    {
        ...
        //-------- Constructor --------
        public Kairos(Texture2D colliderTexture, Texture2D hurtboxTexture, Texture2D hitboxTexture, Texture2D hitEffectTexture, Texture2D blockEffectTexture, List<SoundEffect> soundEffects, InputManager input, Id id, Solid[] bounds, int startingXPos, Texture2D spriteSheet, Camera camera, Random rng)
